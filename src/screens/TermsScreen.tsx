...
export default function TermsScreen() {
    ...
    const sections = [
        ...
        {
            id: 3,
            title: "3. Accessing the App and Account Security",
            content: [
        ...
        {
            id: 11,
            title: "11. Disclaimer Regarding Alcohol Consumption",
            content: [
        ...
        {
            id: 12,
            title: "12. Limitation on Liability",
            content: [
        ...
        {
            id: 17,
            title: "17. Your Comments and Concerns",
            content: [
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                <View style={[styles.card, { backgroundColor: theme.bgSecondary }]}>
                    {sections.map((section) => (
                        <View key={section.id}>
                            <TextComponent variant="h3" style={styles.sectionHeader}>
                                {translateText(section.title, true)}
                            </TextComponent>
