...
export default function TabLayout() {
    ...
    return (
        ...
        >
            ...
            <Tabs.Screen name="active-tour/[id]" options={{ href: null, animation: 'none' }} />

            <Tabs.Screen name="tour-waiting-lobby/[id]" options={{ href: null, animation: 'none' }} />
            <Tabs.Screen name="tour-completed/[id]" options={{ href: null, animation: 'none' }} />
