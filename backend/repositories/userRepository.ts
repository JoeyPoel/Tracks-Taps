...
export const userRepository = {
    ...
    async updateUser(userId: number, data: { name?: string; avatarUrl?: string; referralCode?: string; authId?: string; customTheme?: string | null; lastActiveAt?: Date | null; playStyle?: string | null }) {
